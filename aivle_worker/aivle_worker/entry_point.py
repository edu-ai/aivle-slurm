...
def start_sandbox():
    s = Submission(sid=233,
                   task_url="file:///mnt/c/Users/samso/Documents/GitHub/SamsonYuBaiJian/aivle-slurm/slurm_server/examples/elevator/grader.zip",
                   agent_url="file:///mnt/c/Users/samso/Documents/GitHub/SamsonYuBaiJian/aivle-slurm/slurm_server/examples/elevator/agent.zip",
...
def start():
    # NOTE: might need to get queue info still
